...
export function ReceiptPaper({ vm, paperRef }: ReceiptPaperProps) {
  ...
  return (
    <div className="receipt-paper" ref={paperRef}>
      ...
      {/* Footer: in/out/cache split + cache hit rate (the input/output/cache
          info moved here from the old mid-paper summary block), followed by
          the QR call-to-action, then the brand line. */}
      <footer className="receipt__footer">
        ...
        <div className="receipt__qr-row">
          <img
            ...
            height="56"
          />
          <div className="receipt__qr-cta">
            <span className="receipt__qr-cta-primary">SCAN TO STAR</span>
            <span className="receipt__qr-cta-secondary">github.com/BalianWang/busytok</span>
          </div>
        </div>
