...
use crate::desktop_runtime::{
    detect_launch_reason, host_presentation_config, startup_steps, LaunchReason,
    StartupContext, StartupStep,
};
...
fn lifecycle_status_distinguishes_registered_but_inactive_service() {
    ...
    assert_eq!(LifecycleStatus::RegisteredInactive.as_str(), "registered_inactive");
}
