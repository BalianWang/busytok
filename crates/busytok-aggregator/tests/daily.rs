...
fn date_from_epoch_zero_with_timezone_offset() {
    ...
    let date_plus8 = date_from_timestamp_ms(0, &ReportingTimezone::parse("+08:00").unwrap()).unwrap();
    assert_eq!(date_plus8, "1970-01-01");
    // 1970-01-01 00:00 UTC = 1969-12-31 19:00 -05:00 (previous date)
    let date_minus5 = date_from_timestamp_ms(0, &ReportingTimezone::parse("-05:00").unwrap()).unwrap();
