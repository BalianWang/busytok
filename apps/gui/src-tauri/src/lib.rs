...
pub fn run() {
    ...
    let lifecycle_settings_store =
        std::sync::Arc::new(desktop_lifecycle_settings::DesktopLifecycleSettingsStore::new(
    ...
    let startup_context =
        desktop_runtime::StartupContext::from_launch_reason(launch_reason, lifecycle_settings.clone());
    tracing::info!(
